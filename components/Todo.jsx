...
// Define el componente funcional Todo, que acepta varias props.
const Todo = ({id, title, description, mongoId, complete, deleteTodo, completeTodo}) => {
  // Devuelve JSX que representa una fila de la tabla.

  return (
    <tr className="bg-white border-b white:bg-gray-800 white:border-gray-700">
      <th
        scope="row"
